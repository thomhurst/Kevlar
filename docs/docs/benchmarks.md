...
*Last updated 2026-09-14 17:54 UTC (commit `2b437a3`).*
...
|---|---|---|---|---|---|
| Empty pipeline — async | 12.8 ns | 47.7 ns | 0 B | 0 B | **3.9× faster** |
| Empty pipeline — reference-state baseline | 13.7 ns | — | 0 B | — | — |
| Empty pipeline — caller-seeded context | 96.6 ns | — | 0 B | — | — |
| EmptyOutcomeState | 6.5 ns | — | 0 B | — | — |
| EmptyTaskOutcomeState | 9.2 ns | — | 0 B | — | — |
| Empty pipeline — zero-closure state overload | 13.0 ns | 47.3 ns | 0 B | 0 B | **4.0× faster** |
| Empty pipeline — sync | 7.3 ns | 24.1 ns | 0 B | 0 B | **3.2× faster** |
| NestedEmptyAsync | 165 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Retry(3) — success on first attempt | 111 ns | 198 ns | 0 B | 24 B | **1.8× faster** |
| Retry(3) — two failures then success | 3.16 μs | 3.48 μs | 192 B | 328 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout(10 s) — completes instantly | 165 ns | 155 ns | 0 B | 0 B | on par |
| SynchronousGenerator_HappyPath | 172 ns | — | 0 B | — | — |
| AsynchronousGenerator_HappyPath | 1.32 μs | — | 560 B | — | — |
| AsyncHookConfigured_HappyPath | 163 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Isolated circuit — fast-fail rejection | 4.14 μs | 4.17 μs | 1.3 KB | 1.3 KB | on par |
| Ratio breaker, closed — success | 152 ns | 227 ns | 0 B | 24 B | **1.4× faster** |
| DynamicDurationConfigured | 169 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| NoNotification | 1.92 μs | — | 200 B | — | — |
| CompletedAsyncNotification | 1.88 μs | — | 200 B | — | — |
| YieldingAsyncNotification | 4.40 μs | — | 846 B | — | — |
| Fallback — not triggered | 111 ns | 107 ns | 0 B | 0 B | on par |
| SynchronousDelegate_Triggered | 1.81 μs | — | 200 B | — | — |
| Fallback — triggered by exception | 1.86 μs | 1.87 μs | 200 B | 256 B | on par |
| EmptyVoid | 20.0 ns | — | 0 B | — | — |
| VoidPassThrough | 128 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Token bucket — uncontended acquire | 128 ns | 120 ns | 0 B | 0 B | on par |
| WithHooks_Uncontended | 131 ns | — | 0 B | — | — |
| FrameworkAdapter_Uncontended | 123 ns | — | 0 B | — | — |
| PartitionedFrameworkAdapter_Uncontended | 147 ns | — | 32 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Concurrency limit — uncontended | 127 ns | 163 ns | 0 B | 40 B | **1.3× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Typed retry — result judged, no retry | 126 ns | 161 ns | 0 B | 0 B | **1.4× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout → Retry → ratio breaker | 297 ns | 533 ns | 0 B | 48 B | **1.9× faster** |
| Token bucket → Timeout → Retry → ratio breaker → Concurrency limit | 412 ns | 793 ns | 0 B | 88 B | **2.0× faster** |
| TokenBucketRatioFiveStrategyChainSync | 365 ns | 777 ns | 0 B | 88 B | **2.2× faster** |
