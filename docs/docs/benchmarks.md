...
*Last updated 2026-08-21 11:07 UTC (commit `c5080dc`).*
...
|---|---|---|---|---|---|
| Empty pipeline — async | 2.7 ns | 58.9 ns | 0 B | 0 B | **23× faster** |
| Empty pipeline — zero-closure state overload | 2.5 ns | 61.0 ns | 0 B | 0 B | **25× faster** |
| Empty pipeline — sync | 2.9 ns | 30.5 ns | 0 B | 0 B | **11× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Retry(3) — success on first attempt | 150 ns | 266 ns | 0 B | 24 B | **1.6× faster** |
| Retry(3) — two failures then success | 3.77 μs | 4.48 μs | 192 B | 328 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Closed circuit — success | 186 ns | 278 ns | 0 B | 24 B | **1.5× faster** |
| Open circuit — fast-fail rejection | 5.39 μs | 5.54 μs | 1.3 KB | 1.3 KB | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Hedge(2) — primary wins | 194 ns | 498 ns | 0 B | 0 B | **2.5× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Fallback — not triggered | 121 ns | 135 ns | 0 B | 0 B | on par |
| Fallback — triggered by exception | 2.33 μs | 2.44 μs | 200 B | 256 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Rate limit — uncontended acquire | 153 ns | 161 ns | 0 B | 0 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Concurrency limit — uncontended | 180 ns | 221 ns | 0 B | 40 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Typed retry — result judged, no retry | 163 ns | 210 ns | 0 B | 0 B | **1.3× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Five-strategy chain | 537 ns | 998 ns | 0 B | 88 B | **1.9× faster** |
| Timeout → Retry → Circuit breaker | 372 ns | 709 ns | 0 B | 48 B | **1.9× faster** |
