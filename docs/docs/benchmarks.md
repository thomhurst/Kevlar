...
*Last updated 2026-08-25 11:43 UTC (commit `6a8030c`).*
...
|---|---|---|---|---|---|
| Empty pipeline — async | 14.6 ns | 58.2 ns | 0 B | 0 B | **3.8× faster** |
| Empty pipeline — reference-state baseline | 14.0 ns | — | 0 B | — | — |
| Empty pipeline — caller-seeded context | 117 ns | — | 0 B | — | — |
| EmptyOutcomeState | 9.1 ns | — | 0 B | — | — |
| EmptyTaskOutcomeState | 11.5 ns | — | 0 B | — | — |
| Empty pipeline — zero-closure state overload | 16.2 ns | 62.1 ns | 0 B | 0 B | **3.8× faster** |
| Empty pipeline — sync | 8.6 ns | 28.4 ns | 0 B | 0 B | **3.3× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Retry(3) — success on first attempt | 129 ns | 266 ns | 0 B | 24 B | **2.1× faster** |
| Retry(3) — two failures then success | 4.06 μs | 4.56 μs | 192 B | 328 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout(10 s) — completes instantly | 210 ns | 205 ns | 0 B | 0 B | on par |
| SynchronousGenerator_HappyPath | 222 ns | — | 0 B | — | — |
| AsynchronousGenerator_HappyPath | 1.69 μs | — | 712 B | — | — |
| AsyncHookConfigured_HappyPath | 251 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Isolated circuit — fast-fail rejection | 5.67 μs | 5.74 μs | 1.3 KB | 1.3 KB | on par |
| Ratio breaker, closed — success | 230 ns | 274 ns | 0 B | 24 B | **1.2× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| NoNotification | 2.52 μs | — | 200 B | — | — |
| SyncNotification | 2.56 μs | — | 200 B | — | — |
| CompletedAsyncNotification | 2.53 μs | — | 200 B | — | — |
| YieldingAsyncNotification | 6.28 μs | — | 994 B | — | — |
| Fallback — not triggered | 137 ns | 136 ns | 0 B | 0 B | on par |
| Fallback — triggered by exception | 2.50 μs | 2.54 μs | 200 B | 256 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Token bucket — uncontended acquire | 176 ns | 166 ns | 0 B | 0 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Concurrency limit — uncontended | 158 ns | 205 ns | 0 B | 40 B | **1.3× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Typed retry — result judged, no retry | 125 ns | 203 ns | 0 B | 0 B | **1.7× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout → Retry → ratio breaker | 416 ns | 719 ns | 0 B | 48 B | **1.9× faster** |
| Token bucket → Timeout → Retry → ratio breaker → Concurrency limit | 492 ns | 991 ns | 0 B | 88 B | **1.9× faster** |
