...
*Last updated 2026-08-25 00:03 UTC (commit `f5809a9`).*
...
|---|---|---|---|---|---|
| Empty pipeline — async | 17.1 ns | 61.9 ns | 0 B | 0 B | **3.3× faster** |
...
| Empty pipeline — zero-closure state overload | 13.9 ns | 61.3 ns | 0 B | 0 B | **4.5× faster** |
| Empty pipeline — sync | 8.6 ns | 38.9 ns | 0 B | 0 B | **3.5× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Retry(3) — success on first attempt | 131 ns | 271 ns | 0 B | 24 B | **2.1× faster** |
| Retry(3) — two failures then success | 3.99 μs | 4.46 μs | 192 B | 328 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout(10 s) — completes instantly | 205 ns | 215 ns | 0 B | 0 B | on par |
...
| Ratio breaker, closed — success | 216 ns | 276 ns | 0 B | 24 B | **1.2× faster** |
| DynamicDurationConfigured | 229 ns | — | 0 B | — | — |
...
| YieldingAsyncNotification | 5.99 μs | — | 852 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Token bucket — uncontended acquire | 166 ns | 158 ns | 0 B | 0 B | on par |
| WithHooks_Uncontended | 169 ns | — | 0 B | — | — |
| FrameworkAdapter_Uncontended | 152 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Concurrency limit — uncontended | 173 ns | 207 ns | 0 B | 40 B | **1.3× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Typed retry — result judged, no retry | 139 ns | 206 ns | 0 B | 0 B | **1.6× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout → Retry → ratio breaker | 354 ns | 684 ns | 0 B | 48 B | **1.9× faster** |
| Token bucket → Timeout → Retry → ratio breaker → Concurrency limit | 482 ns | 998 ns | 0 B | 88 B | **2.0× faster** |
