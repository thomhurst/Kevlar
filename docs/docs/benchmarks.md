...
*Last updated 2026-08-20 20:20 UTC (commit `22100f4`).*
...
|---|---|---|---|---|---|
| Empty pipeline — async | 2.6 ns | 59.9 ns | 0 B | 0 B | **27× faster** |
| Empty pipeline — zero-closure state overload | 2.7 ns | 66.5 ns | 0 B | 0 B | **36× faster** |
| Empty pipeline — sync | 2.5 ns | 30.8 ns | 0 B | 0 B | **16× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Retry(3) — success on first attempt | 175 ns | 273 ns | 0 B | 24 B | **1.5× faster** |
| Retry(3) — two failures then success | 3.76 μs | 4.51 μs | 192 B | 328 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout(10 s) — completes instantly | 263 ns | 210 ns | 168 B | 0 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Closed circuit — success | 195 ns | 273 ns | 0 B | 24 B | **1.4× faster** |
| Open circuit — fast-fail rejection | 5.27 μs | 5.29 μs | 1.3 KB | 1.3 KB | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Hedge(2) — primary wins | 216 ns | 477 ns | 0 B | 0 B | **1.6× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Fallback — not triggered | 185 ns | 140 ns | 0 B | 0 B | 1.3× slower |
| Fallback — triggered by exception | 2.45 μs | 2.40 μs | 200 B | 256 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Rate limit — uncontended acquire | 222 ns | 158 ns | 0 B | 0 B | 1.4× slower |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Concurrency limit — uncontended | 201 ns | 211 ns | 0 B | 40 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Typed retry — result judged, no retry | 175 ns | 208 ns | 0 B | 0 B | **1.2× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Five-strategy chain | 774 ns | 1.04 μs | 168 B | 88 B | **1.3× faster** |
| Timeout → Retry → Circuit breaker | 467 ns | 712 ns | 168 B | 48 B | **1.5× faster** |
