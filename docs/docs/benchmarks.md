...
*Last updated 2026-08-25 14:22 UTC (commit `6194c18`).*
...
|---|---|---|---|---|---|
| Empty pipeline — async | 17.5 ns | 79.3 ns | 0 B | 0 B | **3.9× faster** |
...
| EmptyTaskOutcomeState | 17.7 ns | — | 0 B | — | — |
| Empty pipeline — zero-closure state overload | 16.8 ns | 61.7 ns | 0 B | 0 B | **3.7× faster** |
| Empty pipeline — sync | 10.0 ns | 30.4 ns | 0 B | 0 B | **3.3× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Retry(3) — success on first attempt | 136 ns | 262 ns | 0 B | 24 B | **2.1× faster** |
| Retry(3) — two failures then success | 3.97 μs | 4.41 μs | 192 B | 328 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout(10 s) — completes instantly | 205 ns | 209 ns | 0 B | 0 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Isolated circuit — fast-fail rejection | 5.26 μs | 5.33 μs | 1.3 KB | 1.3 KB | on par |
| Ratio breaker, closed — success | 233 ns | 281 ns | 0 B | 24 B | **1.2× faster** |
| DynamicDurationConfigured | 262 ns | — | 0 B | — | — |
| AsyncCallbackConfigured | 252 ns | — | 0 B | — | — |
...
| Fallback — not triggered | 137 ns | 142 ns | 0 B | 0 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Token bucket — uncontended acquire | 209 ns | 157 ns | 0 B | 0 B | on par |
| WithHooks_Uncontended | 163 ns | — | 0 B | — | — |
| FrameworkAdapter_Uncontended | 162 ns | — | 0 B | — | — |
| PartitionedFrameworkAdapter_Uncontended | 184 ns | — | 32 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Concurrency limit — uncontended | 160 ns | 216 ns | 0 B | 40 B | **1.3× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Typed retry — result judged, no retry | 136 ns | 214 ns | 0 B | 0 B | **1.6× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout → Retry → ratio breaker | 392 ns | 691 ns | 0 B | 48 B | **1.8× faster** |
| Token bucket → Timeout → Retry → ratio breaker → Concurrency limit | 508 ns | 991 ns | 0 B | 88 B | **1.9× faster** |
| TokenBucketRatioFiveStrategyChainSync | 470 ns | 993 ns | 0 B | 88 B | **2.1× faster** |
