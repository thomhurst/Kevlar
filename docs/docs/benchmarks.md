...
*Last updated 2026-09-21 11:21 UTC (commit `24c7640`).*
...
|---|---|---|---|---|---|
| Empty pipeline — async | 13.8 ns | 46.3 ns | 0 B | 0 B | **3.6× faster** |
| Empty pipeline — reference-state baseline | 13.7 ns | — | 0 B | — | — |
| Empty pipeline — caller-seeded context | 97.5 ns | — | 0 B | — | — |
| EmptyOutcomeState | 8.9 ns | — | 0 B | — | — |
| EmptyTaskOutcomeState | 12.4 ns | — | 0 B | — | — |
| Empty pipeline — zero-closure state overload | 12.6 ns | 49.3 ns | 0 B | 0 B | **4.0× faster** |
| Empty pipeline — sync | 7.1 ns | 24.1 ns | 0 B | 0 B | **3.2× faster** |
| NestedEmptyAsync | 221 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Retry(3) — success on first attempt | 117 ns | 201 ns | 0 B | 24 B | **1.8× faster** |
| Retry(3) — two failures then success | 3.19 μs | 3.46 μs | 192 B | 328 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout(10 s) — completes instantly | 171 ns | 158 ns | 0 B | 0 B | on par |
| SynchronousGenerator_HappyPath | 174 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Isolated circuit — fast-fail rejection | 4.16 μs | 4.20 μs | 1.3 KB | 1.3 KB | on par |
| Ratio breaker, closed — success | 153 ns | 222 ns | 0 B | 24 B | **1.4× faster** |
| DynamicDurationConfigured | 171 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| NoNotification | 1.89 μs | — | 200 B | — | — |
| CompletedAsyncNotification | 1.90 μs | — | 200 B | — | — |
| YieldingAsyncNotification | 4.41 μs | — | 840 B | — | — |
| Fallback — not triggered | 116 ns | 109 ns | 0 B | 0 B | on par |
| SynchronousDelegate_Triggered | 1.83 μs | — | 200 B | — | — |
| Fallback — triggered by exception | 1.87 μs | 1.88 μs | 200 B | 256 B | on par |
| EmptyVoid | 20.8 ns | — | 0 B | — | — |
| VoidPassThrough | 127 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Token bucket — uncontended acquire | 133 ns | 119 ns | 0 B | 0 B | on par |
| WithHooks_Uncontended | 131 ns | — | 0 B | — | — |
| FrameworkAdapter_Uncontended | 126 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Concurrency limit — uncontended | 129 ns | 162 ns | 0 B | 40 B | **1.3× faster** |
| WithHooks_Uncontended | 130 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Typed retry — result judged, no retry | 115 ns | 157 ns | 0 B | 0 B | **1.4× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout → Retry → ratio breaker | 301 ns | 533 ns | 0 B | 48 B | **1.9× faster** |
| Token bucket → Timeout → Retry → ratio breaker → Concurrency limit | 394 ns | 771 ns | 0 B | 88 B | **2.0× faster** |
| TokenBucketRatioFiveStrategyChainSync | 362 ns | 780 ns | 0 B | 88 B | **2.2× faster** |
