...
*Last updated 2026-08-26 22:40 UTC (commit `9b6e099`).*
...
|---|---|---|---|---|---|
| Empty pipeline — async | 10.7 ns | 43.1 ns | 0 B | 0 B | **3.9× faster** |
| Empty pipeline — reference-state baseline | 9.4 ns | — | 0 B | — | — |
| Empty pipeline — caller-seeded context | 69.9 ns | — | 0 B | — | — |
| EmptyOutcomeState | 6.0 ns | — | 0 B | — | — |
| EmptyTaskOutcomeState | 6.3 ns | — | 0 B | — | — |
| Empty pipeline — zero-closure state overload | 10.0 ns | 44.2 ns | 0 B | 0 B | **3.8× faster** |
| Empty pipeline — sync | 8.4 ns | 28.9 ns | 0 B | 0 B | **3.4× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Retry(3) — success on first attempt | 81.2 ns | 164 ns | 0 B | 24 B | **1.9× faster** |
| Retry(3) — two failures then success | 2.39 μs | 2.82 μs | 192 B | 328 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout(10 s) — completes instantly | 139 ns | 142 ns | 0 B | 0 B | on par |
| SynchronousGenerator_HappyPath | 141 ns | — | 0 B | — | — |
| AsynchronousGenerator_HappyPath | 1.75 μs | — | 723 B | — | — |
| AsyncHookConfigured_HappyPath | 137 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Isolated circuit — fast-fail rejection | 3.60 μs | 3.56 μs | 1.3 KB | 1.3 KB | on par |
| Ratio breaker, closed — success | 151 ns | 180 ns | 0 B | 24 B | **1.2× faster** |
| DynamicDurationConfigured | 158 ns | — | 0 B | — | — |
| AsyncCallbackConfigured | 161 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| NoNotification | 1.53 μs | — | 200 B | — | — |
| CompletedAsyncNotification | 1.52 μs | — | 200 B | — | — |
| YieldingAsyncNotification | 4.56 μs | — | 1005 B | — | — |
| Fallback — not triggered | 83.6 ns | 86.9 ns | 0 B | 0 B | on par |
| Fallback — triggered by exception | 1.50 μs | 1.53 μs | 200 B | 256 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Token bucket — uncontended acquire | 100 ns | 106 ns | 0 B | 0 B | on par |
| WithHooks_Uncontended | 102 ns | — | 0 B | — | — |
| FrameworkAdapter_Uncontended | 104 ns | — | 0 B | — | — |
| PartitionedFrameworkAdapter_Uncontended | 123 ns | — | 32 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Concurrency limit — uncontended | 115 ns | 154 ns | 0 B | 40 B | **1.3× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Typed retry — result judged, no retry | 78.7 ns | 138 ns | 0 B | 0 B | **1.6× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout → Retry → ratio breaker | 254 ns | 432 ns | 0 B | 48 B | **1.8× faster** |
| Token bucket → Timeout → Retry → ratio breaker → Concurrency limit | 334 ns | 613 ns | 0 B | 88 B | **1.9× faster** |
| TokenBucketRatioFiveStrategyChainSync | 308 ns | 611 ns | 0 B | 88 B | **2.0× faster** |
