...
*Last updated 2026-08-31 19:06 UTC (commit `20f9e1b`).*
...
|---|---|---|---|---|---|
| Empty pipeline — async | 17.1 ns | 62.0 ns | 0 B | 0 B | **3.6× faster** |
...
| Empty pipeline — zero-closure state overload | 17.6 ns | 61.7 ns | 0 B | 0 B | **4.0× faster** |
| Empty pipeline — sync | 9.3 ns | 29.5 ns | 0 B | 0 B | **3.2× faster** |
| NestedEmptyAsync | 239 ns | — | 0 B | — | — |
| NestedEmptySync | 152 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Retry(3) — success on first attempt | 160 ns | 268 ns | 0 B | 24 B | **1.8× faster** |
| Retry(3) — two failures then success | 4.06 μs | 4.47 μs | 192 B | 328 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout(10 s) — completes instantly | 243 ns | 222 ns | 0 B | 0 B | on par |
| SynchronousGenerator_HappyPath | 257 ns | — | 0 B | — | — |
| AsynchronousGenerator_HappyPath | 1.74 μs | — | 728 B | — | — |
| AsyncHookConfigured_HappyPath | 249 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Isolated circuit — fast-fail rejection | 5.41 μs | 5.49 μs | 1.3 KB | 1.3 KB | on par |
| Ratio breaker, closed — success | 223 ns | 273 ns | 0 B | 24 B | on par |
| DynamicDurationConfigured | 235 ns | — | 0 B | — | — |
| AsyncCallbackConfigured | 241 ns | — | 0 B | — | — |
...
| YieldingAsyncNotification | 6.06 μs | — | 1018 B | — | — |
| Fallback — not triggered | 147 ns | 137 ns | 0 B | 0 B | on par |
| SynchronousDelegate_Triggered | 2.33 μs | — | 200 B | — | — |
| Fallback — triggered by exception | 2.44 μs | 2.44 μs | 200 B | 256 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Token bucket — uncontended acquire | 176 ns | 161 ns | 0 B | 0 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Concurrency limit — uncontended | 169 ns | 215 ns | 0 B | 40 B | **1.2× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Typed retry — result judged, no retry | 161 ns | 199 ns | 0 B | 0 B | **1.4× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout → Retry → ratio breaker | 421 ns | 687 ns | 0 B | 48 B | **1.6× faster** |
| Token bucket → Timeout → Retry → ratio breaker → Concurrency limit | 547 ns | 990 ns | 0 B | 88 B | **1.8× faster** |
| TokenBucketRatioFiveStrategyChainSync | 506 ns | 1.01 μs | 0 B | 88 B | **1.9× faster** |
