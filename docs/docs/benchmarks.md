...
*Last updated 2026-09-21 05:43 UTC (commit `3f078a9`).*
...
|---|---|---|---|---|---|
| Empty pipeline — async | 14.6 ns | 57.7 ns | 0 B | 0 B | **3.6× faster** |
| Empty pipeline — reference-state baseline | 14.3 ns | — | 0 B | — | — |
| Empty pipeline — caller-seeded context | 124 ns | — | 0 B | — | — |
| EmptyOutcomeState | 9.7 ns | — | 0 B | — | — |
| EmptyTaskOutcomeState | 12.3 ns | — | 0 B | — | — |
| Empty pipeline — zero-closure state overload | 17.7 ns | 60.6 ns | 0 B | 0 B | **3.9× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Retry(3) — success on first attempt | 143 ns | 257 ns | 0 B | 24 B | **1.8× faster** |
| Retry(3) — two failures then success | 4.30 μs | 4.47 μs | 192 B | 328 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout(10 s) — completes instantly | 215 ns | 204 ns | 0 B | 0 B | on par |
| SynchronousGenerator_HappyPath | 236 ns | — | 0 B | — | — |
| AsynchronousGenerator_HappyPath | 1.72 μs | — | 560 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Isolated circuit — fast-fail rejection | 5.49 μs | 5.54 μs | 1.3 KB | 1.3 KB | on par |
| Ratio breaker, closed — success | 193 ns | 270 ns | 0 B | 24 B | **1.4× faster** |
| DynamicDurationConfigured | 221 ns | — | 0 B | — | — |
| AsyncCallbackConfigured | 214 ns | — | 0 B | — | — |
...
| YieldingAsyncNotification | 6.39 μs | — | 823 B | — | — |
| Fallback — not triggered | 161 ns | 137 ns | 0 B | 0 B | on par |
| SynchronousDelegate_Triggered | 2.36 μs | — | 200 B | — | — |
| Fallback — triggered by exception | 2.49 μs | 2.49 μs | 200 B | 256 B | on par |
| EmptyVoid | 27.5 ns | — | 0 B | — | — |
| VoidPassThrough | 195 ns | — | 0 B | — | — |
...
| FrameworkAdapter_Uncontended | 163 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Concurrency limit — uncontended | 164 ns | 200 ns | 0 B | 40 B | **1.3× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Typed retry — result judged, no retry | 149 ns | 207 ns | 0 B | 0 B | **1.4× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout → Retry → ratio breaker | 353 ns | 713 ns | 0 B | 48 B | **1.9× faster** |
| Token bucket → Timeout → Retry → ratio breaker → Concurrency limit | 511 ns | 992 ns | 0 B | 88 B | **2.0× faster** |
| TokenBucketRatioFiveStrategyChainSync | 479 ns | 1.01 μs | 0 B | 88 B | **2.2× faster** |
