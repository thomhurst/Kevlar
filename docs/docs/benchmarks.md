...
*Last updated 2026-08-22 18:12 UTC (commit `d72d915`).*
...
|---|---|---|---|---|---|
| Empty pipeline — async | 18.8 ns | 62.6 ns | 0 B | 0 B | **3.2× faster** |
...
| EmptyTaskOutcomeState | 11.8 ns | — | 0 B | — | — |
| Empty pipeline — zero-closure state overload | 13.6 ns | 63.3 ns | 0 B | 0 B | **4.5× faster** |
| Empty pipeline — sync | 11.7 ns | 31.1 ns | 0 B | 0 B | **3.8× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Retry(3) — success on first attempt | 126 ns | 257 ns | 0 B | 24 B | **1.7× faster** |
| Retry(3) — two failures then success | 3.90 μs | 4.43 μs | 192 B | 328 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout(10 s) — completes instantly | 205 ns | 207 ns | 0 B | 0 B | on par |
| SynchronousGenerator_HappyPath | 212 ns | — | 0 B | — | — |
| AsynchronousGenerator_HappyPath | 1.74 μs | — | 696 B | — | — |
| AsyncHookConfigured_HappyPath | 205 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Isolated circuit — fast-fail rejection | 5.32 μs | 5.26 μs | 1.3 KB | 1.3 KB | on par |
| Ratio breaker, closed — success | 231 ns | 287 ns | 0 B | 24 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| NoNotification | 2.33 μs | — | 200 B | — | — |
| SyncNotification | 2.33 μs | — | 200 B | — | — |
| CompletedAsyncNotification | 2.35 μs | — | 200 B | — | — |
| YieldingAsyncNotification | 5.45 μs | — | 855 B | — | — |
| Fallback — not triggered | 141 ns | 143 ns | 0 B | 0 B | on par |
| Fallback — triggered by exception | 2.33 μs | 2.38 μs | 200 B | 256 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Token bucket — uncontended acquire | 172 ns | 152 ns | 0 B | 0 B | on par |
| WithHooks_Uncontended | 169 ns | — | 0 B | — | — |
| FrameworkAdapter_Uncontended | 151 ns | — | 0 B | — | — |
| PartitionedFrameworkAdapter_Uncontended | 181 ns | — | 32 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Concurrency limit — uncontended | 161 ns | 210 ns | 0 B | 40 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Typed retry — result judged, no retry | 126 ns | 214 ns | 0 B | 0 B | **1.3× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout → Retry → ratio breaker | 380 ns | 726 ns | 0 B | 48 B | **1.8× faster** |
| Token bucket → Timeout → Retry → ratio breaker → Concurrency limit | 520 ns | 1.01 μs | 0 B | 88 B | **1.9× faster** |
