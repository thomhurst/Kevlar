...
*Last updated 2026-09-14 16:22 UTC (commit `5c57e7d`).*
...
|---|---|---|---|---|---|
| Empty pipeline — async | 17.2 ns | 58.2 ns | 0 B | 0 B | **4.0× faster** |
...
| Empty pipeline — zero-closure state overload | 17.6 ns | 60.8 ns | 0 B | 0 B | **4.4× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Retry(3) — success on first attempt | 141 ns | 259 ns | 0 B | 24 B | **1.9× faster** |
| Retry(3) — two failures then success | 4.23 μs | 4.39 μs | 192 B | 328 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout(10 s) — completes instantly | 215 ns | 223 ns | 0 B | 0 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Isolated circuit — fast-fail rejection | 5.64 μs | 5.50 μs | 1.3 KB | 1.3 KB | on par |
| Ratio breaker, closed — success | 191 ns | 265 ns | 0 B | 24 B | **1.4× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| NoNotification | 2.50 μs | — | 200 B | — | — |
| CompletedAsyncNotification | 2.55 μs | — | 200 B | — | — |
| YieldingAsyncNotification | 6.37 μs | — | 814 B | — | — |
| Fallback — not triggered | 148 ns | 136 ns | 0 B | 0 B | on par |
| SynchronousDelegate_Triggered | 2.40 μs | — | 200 B | — | — |
| Fallback — triggered by exception | 2.48 μs | 2.56 μs | 200 B | 256 B | on par |
| EmptyVoid | 29.3 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Token bucket — uncontended acquire | 169 ns | 165 ns | 0 B | 0 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Typed retry — result judged, no retry | 159 ns | 201 ns | 0 B | 0 B | **1.4× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout → Retry → ratio breaker | 351 ns | 711 ns | 0 B | 48 B | **1.9× faster** |
| Token bucket → Timeout → Retry → ratio breaker → Concurrency limit | 500 ns | 1.01 μs | 0 B | 88 B | **2.0× faster** |
| TokenBucketRatioFiveStrategyChainSync | 459 ns | 1.03 μs | 0 B | 88 B | **2.2× faster** |
