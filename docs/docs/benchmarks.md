...
*Last updated 2026-08-26 08:38 UTC (commit `17855a3`).*
...
|---|---|---|---|---|---|
| Empty pipeline — async | 17.1 ns | 58.2 ns | 0 B | 0 B | **4.0× faster** |
...
| Empty pipeline — zero-closure state overload | 16.3 ns | 63.0 ns | 0 B | 0 B | **3.8× faster** |
| Empty pipeline — sync | 8.7 ns | 29.0 ns | 0 B | 0 B | **3.3× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Retry(3) — success on first attempt | 144 ns | 260 ns | 0 B | 24 B | **2.0× faster** |
| Retry(3) — two failures then success | 4.08 μs | 4.55 μs | 192 B | 328 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout(10 s) — completes instantly | 228 ns | 209 ns | 0 B | 0 B | on par |
| SynchronousGenerator_HappyPath | 221 ns | — | 0 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Isolated circuit — fast-fail rejection | 5.51 μs | 5.56 μs | 1.3 KB | 1.3 KB | on par |
| Ratio breaker, closed — success | 226 ns | 266 ns | 0 B | 24 B | **1.2× faster** |
| DynamicDurationConfigured | 247 ns | — | 0 B | — | — |
| AsyncCallbackConfigured | 247 ns | — | 0 B | — | — |
...
| SyncNotification | 2.46 μs | — | 200 B | — | — |
| CompletedAsyncNotification | 2.47 μs | — | 200 B | — | — |
| YieldingAsyncNotification | 6.29 μs | — | 1013 B | — | — |
| Fallback — not triggered | 144 ns | 135 ns | 0 B | 0 B | on par |
| Fallback — triggered by exception | 2.48 μs | 2.50 μs | 200 B | 256 B | on par |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Token bucket — uncontended acquire | 165 ns | 164 ns | 0 B | 0 B | on par |
| WithHooks_Uncontended | 166 ns | — | 0 B | — | — |
| FrameworkAdapter_Uncontended | 158 ns | — | 0 B | — | — |
| PartitionedFrameworkAdapter_Uncontended | 208 ns | — | 32 B | — | — |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Concurrency limit — uncontended | 164 ns | 203 ns | 0 B | 40 B | **1.3× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Typed retry — result judged, no retry | 135 ns | 219 ns | 0 B | 0 B | **1.6× faster** |
...
| Scenario | Kevlar | Polly | Kevlar allocated | Polly allocated | Kevlar vs Polly |
|---|---|---|---|---|---|
| Timeout → Retry → ratio breaker | 386 ns | 695 ns | 0 B | 48 B | **1.8× faster** |
| Token bucket → Timeout → Retry → ratio breaker → Concurrency limit | 534 ns | 1.02 μs | 0 B | 88 B | **1.9× faster** |
| TokenBucketRatioFiveStrategyChainSync | 497 ns | 992 ns | 0 B | 88 B | **2.0× faster** |
