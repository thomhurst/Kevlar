...
*Last updated 2026-08-24 06:33 UTC (commit `57d5524`).*
...
|---|---:|---:|---:|---:|---:|---:|
| Kevlar | 3.70M ops/s | 1.67B | 9.12 KiB | 0.00 B | 222.27 KiB / 293.05 KiB | 0 / 0 / 0 |
| Polly | 2.65M ops/s | 1.19B | 53.21 GiB | 48.00 B | 217.99 KiB / 15.51 MiB | 3422 / 44 / 4 |

Kevlar completed **1.40×** as many operations per second as Polly in this run.
