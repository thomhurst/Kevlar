...
*Last updated 2026-08-25 17:34 UTC (commit `ec40612`).*
...
|---|---:|---:|---:|---:|---:|---:|
| Kevlar | 3.63M ops/s | 1.63B | 8.05 KiB | 0.00 B | 232.05 KiB / 279.16 KiB | 0 / 0 / 0 |
| Polly | 2.75M ops/s | 1.24B | 55.27 GiB | 48.00 B | 231.38 KiB / 7.30 MiB | 3555 / 44 / 4 |

Kevlar completed **1.32×** as many operations per second as Polly in this run.
...
- Peak working set for the shared process: 72.63 MiB.
