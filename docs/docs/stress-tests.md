...
*Last updated 2026-08-27 23:23 UTC (commit `8680d7a`).*
...
|---|---:|---:|---:|---:|---:|---:|
| Kevlar | 2.15M ops/s | 966.90M | 8.39 KiB | 0.00 B | 246.30 KiB / 286.35 KiB | 0 / 0 / 0 |
| Polly | 2.46M ops/s | 1.11B | 49.43 GiB | 48.00 B | 229.68 KiB / 50.75 MiB | 634 / 44 / 4 |

Kevlar completed **0.87×** as many operations per second as Polly in this run.
...
- Peak working set for the shared process: 136.38 MiB.
