...
/// Do not reuse a shield after its partition is evicted. A later lookup creates a fresh partition
/// with fresh strategy state. Partition keys are never added to metric tags or shield names
/// automatically.
/// </remarks>
