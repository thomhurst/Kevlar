...
/// <item><c>kevlar.concurrency_limit.inflight</c>, <c>queued</c>, and <c>capacity</c> — concurrency-limit state gauges</item>
/// <item><c>kevlar.rate_limit.available</c> and <c>queued</c> — rate-limit state gauges</item>
/// </list>
