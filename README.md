...
The core package depends on `Reservoir` `[1.8.0, 2.0.0)` on every target. Its `netstandard2.0`
...
for bugs, feature requests, and questions; report vulnerabilities through GitHub's
