...
public class IgnoredCancellationTokenTests
{
    ...
    [
        ...
        ("KevlarContext parent = null!; var result = Shield.Empty.ExecuteWithContext(context => 1, parent);", "Kevlar.Shield.ExecuteWithContext(System.Func<Kevlar.KevlarContext,M0>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; var result = Shield.Empty.ExecuteWithContext(1, (state, context) => state, parent);", "Kevlar.Shield.ExecuteWithContext(M1,System.Func<M1,Kevlar.KevlarContext,M0>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; Shield.Empty.ExecuteWithContext(context => { }, parent);", "Kevlar.Shield.ExecuteWithContext(System.Action<Kevlar.KevlarContext>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; Shield.Empty.ExecuteWithContext(1, (state, context) => { _ = state; }, parent);", "Kevlar.Shield.ExecuteWithContext(M0,System.Action<M0,Kevlar.KevlarContext>,Kevlar.KevlarContext)"),
        ("var result = Shield.Empty.ExecuteOutcome(ct => 1);", "Kevlar.Shield.ExecuteOutcome(System.Func<System.Threading.CancellationToken,M0>,System.Threading.CancellationToken)"),
        ("var result = Shield.Empty.ExecuteOutcome(1, (state, ct) => state);", "Kevlar.Shield.ExecuteOutcome(M1,System.Func<M1,System.Threading.CancellationToken,M0>,System.Threading.CancellationToken)"),
        ("Shield.Empty.ExecuteOutcome(ct => { });", "Kevlar.Shield.ExecuteOutcome(System.Action<System.Threading.CancellationToken>,System.Threading.CancellationToken)"),
        ("Shield.Empty.ExecuteOutcome(1, (state, ct) => { _ = state; });", "Kevlar.Shield.ExecuteOutcome(M0,System.Action<M0,System.Threading.CancellationToken>,System.Threading.CancellationToken)"),
        ...
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(context => new ValueTask<int>(1), parent);", "Kevlar.Shield.ExecuteWithContextAsync(System.Func<Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<M0>>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(1, (state, context) => new ValueTask<int>(state), parent);", "Kevlar.Shield.ExecuteWithContextAsync(M1,System.Func<M1,Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<M0>>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(context => ValueTask.CompletedTask, parent);", "Kevlar.Shield.ExecuteWithContextAsync(System.Func<Kevlar.KevlarContext,System.Threading.Tasks.ValueTask>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(1, (state, context) => { _ = state; return ValueTask.CompletedTask; }, parent);", "Kevlar.Shield.ExecuteWithContextAsync(M0,System.Func<M0,Kevlar.KevlarContext,System.Threading.Tasks.ValueTask>,Kevlar.KevlarContext)"),
        ...
        ("await Shield.Empty.ExecuteOutcomeAsync(ct => ValueTask.CompletedTask);", "Kevlar.Shield.ExecuteOutcomeAsync(System.Func<System.Threading.CancellationToken,System.Threading.Tasks.ValueTask>,System.Threading.CancellationToken)"),
        ("await Shield.Empty.ExecuteOutcomeAsync(1, (state, ct) => { _ = state; return ValueTask.CompletedTask; });", "Kevlar.Shield.ExecuteOutcomeAsync(M0,System.Func<M0,System.Threading.CancellationToken,System.Threading.Tasks.ValueTask>,System.Threading.CancellationToken)"),
        ...
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(context => Task.FromResult(1), parent);", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield,System.Func<Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(1, (state, context) => Task.FromResult(state), parent);", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield,M1,System.Func<M1,Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(context => Task.CompletedTask, parent);", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield,System.Func<Kevlar.KevlarContext,System.Threading.Tasks.Task>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(1, (state, context) => { _ = state; return Task.CompletedTask; }, parent);", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield,M0,System.Func<M0,Kevlar.KevlarContext,System.Threading.Tasks.Task>,Kevlar.KevlarContext)"),
        ...
        ("await Shield.Empty.ExecuteOutcomeAsync(ct => Task.CompletedTask);", "Kevlar.ShieldTaskExtensions.ExecuteOutcomeAsync(Kevlar.Shield,System.Func<System.Threading.CancellationToken,System.Threading.Tasks.Task>,System.Threading.CancellationToken)"),
        ("await Shield.Empty.ExecuteOutcomeAsync(1, (state, ct) => { _ = state; return Task.CompletedTask; });", "Kevlar.ShieldTaskExtensions.ExecuteOutcomeAsync(Kevlar.Shield,M0,System.Func<M0,System.Threading.CancellationToken,System.Threading.Tasks.Task>,System.Threading.CancellationToken)"),
        ...
        ("KevlarContext parent = null!; var result = Shield<int>.Empty.ExecuteWithContext(context => 1, parent);", "Kevlar.Shield<T0>.ExecuteWithContext(System.Func<Kevlar.KevlarContext,T0>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; var result = Shield<int>.Empty.ExecuteWithContext(1, (state, context) => state, parent);", "Kevlar.Shield<T0>.ExecuteWithContext(M0,System.Func<M0,Kevlar.KevlarContext,T0>,Kevlar.KevlarContext)"),
        ("var result = Shield<int>.Empty.ExecuteOutcome(ct => 1);", "Kevlar.Shield<T0>.ExecuteOutcome(System.Func<System.Threading.CancellationToken,T0>,System.Threading.CancellationToken)"),
        ("var result = Shield<int>.Empty.ExecuteOutcome(1, (state, ct) => state);", "Kevlar.Shield<T0>.ExecuteOutcome(M0,System.Func<M0,System.Threading.CancellationToken,T0>,System.Threading.CancellationToken)"),
        ...
        ("KevlarContext parent = null!; await Shield<int>.Empty.ExecuteWithContextAsync(context => new ValueTask<int>(1), parent);", "Kevlar.Shield<T0>.ExecuteWithContextAsync(System.Func<Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<T0>>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield<int>.Empty.ExecuteWithContextAsync(1, (state, context) => new ValueTask<int>(state), parent);", "Kevlar.Shield<T0>.ExecuteWithContextAsync(M0,System.Func<M0,Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<T0>>,Kevlar.KevlarContext)"),
        ...
        ("KevlarContext parent = null!; await Shield<int>.Empty.ExecuteWithContextAsync(context => Task.FromResult(1), parent);", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield<M0>,System.Func<Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield<int>.Empty.ExecuteWithContextAsync(1, (state, context) => Task.FromResult(state), parent);", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield<M0>,M1,System.Func<M1,Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>,Kevlar.KevlarContext)"),
        ...
        ("await Shield.Empty.ExecuteWithContextAsync(1, (_, _) => { }, (state, context) => new ValueTask<int>(state), (_, _) => { });", "Kevlar.Shield.ExecuteWithContextAsync(M1,System.Action<M1,Kevlar.KevlarProperties>,System.Func<M1,Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<M0>>,System.Action<M1,Kevlar.KevlarProperties>,System.Threading.CancellationToken)"),
        ("await Shield.Empty.ExecuteWithContextAsync(1, (_, _) => { }, (state, context) => { _ = state; return ValueTask.CompletedTask; }, (_, _) => { });", "Kevlar.Shield.ExecuteWithContextAsync(M0,System.Action<M0,Kevlar.KevlarProperties>,System.Func<M0,Kevlar.KevlarContext,System.Threading.Tasks.ValueTask>,System.Action<M0,Kevlar.KevlarProperties>,System.Threading.CancellationToken)"),
        ("await Shield<int>.Empty.ExecuteWithContextAsync(1, (_, _) => { }, (state, context) => new ValueTask<int>(state), (_, _) => { });", "Kevlar.Shield<T0>.ExecuteWithContextAsync(M0,System.Action<M0,Kevlar.KevlarProperties>,System.Func<M0,Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<T0>>,System.Action<M0,Kevlar.KevlarProperties>,System.Threading.CancellationToken)"),
        ("await Shield.Empty.ExecuteWithContextAsync(1, (_, _) => { }, (state, context) => Task.FromResult(state), (_, _) => { });", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield,M1,System.Action<M1,Kevlar.KevlarProperties>,System.Func<M1,Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>,System.Action<M1,Kevlar.KevlarProperties>,System.Threading.CancellationToken)"),
        ("await Shield.Empty.ExecuteWithContextAsync(1, (_, _) => { }, (state, context) => { _ = state; return Task.CompletedTask; }, (_, _) => { });", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield,M0,System.Action<M0,Kevlar.KevlarProperties>,System.Func<M0,Kevlar.KevlarContext,System.Threading.Tasks.Task>,System.Action<M0,Kevlar.KevlarProperties>,System.Threading.CancellationToken)"),
        ("await Shield<int>.Empty.ExecuteWithContextAsync(1, (_, _) => { }, (state, context) => Task.FromResult(state), (_, _) => { });", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield<M0>,M1,System.Action<M1,Kevlar.KevlarProperties>,System.Func<M1,Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>,System.Action<M1,Kevlar.KevlarProperties>,System.Threading.CancellationToken)"),
    ];

    private static readonly string[] CleanContextExecutionCases =
    [
        "var result = Shield.Empty.ExecuteWithContext(1, static (_, _) => { }, static (_, context) => context.CancellationToken.GetHashCode());",
        "Shield.Empty.ExecuteWithContext(1, static (_, _) => { }, static (_, context) => context.CancellationToken.ThrowIfCancellationRequested());",
        "await Shield.Empty.ExecuteWithContextAsync(1, static (_, _) => { }, static (_, context) => new ValueTask<int>(context.CancellationToken.GetHashCode()));",
        "await Shield.Empty.ExecuteWithContextAsync(1, static (_, _) => { }, static (_, context) => { context.CancellationToken.ThrowIfCancellationRequested(); return ValueTask.CompletedTask; });",
        "await Shield.Empty.ExecuteWithContextAsync(1, static (_, _) => { }, static (_, context) => Task.FromResult(context.CancellationToken.GetHashCode()));",
        "await Shield.Empty.ExecuteWithContextAsync(1, static (_, _) => { }, static (_, context) => { context.CancellationToken.ThrowIfCancellationRequested(); return Task.CompletedTask; });",
    ...
    private static bool IsExecutionMethod(IMethodSymbol method) =>
        method.Name is "Execute" or "ExecuteAsync" or "ExecuteOutcome" or "ExecuteOutcomeAsync"
    ...
    [Test]
    public Task Context_Action_Families_Accept_The_Effective_Token() =>
        AssertDiagnosticCountAsync(CleanContextExecutionCases, 0, "context token used");

    [Test]
    public async Task Reassigned_Context_Alias_Does_Not_Suppress_The_Diagnostic()
    {
        var direct = await AnalyzeAsync("""
            ...
            """);
        await Assert.That(direct.Length).IsEqualTo(1);

        var conditional = await AnalyzeAsync("""
            KevlarContext state = null!;
            await Shield.Empty.ExecuteWithContextAsync(
                state,
                static (_, _) => { },
            ...
            """);
        await Assert.That(conditional.Length).IsEqualTo(1);
    }

    [Test]
    public async Task Context_Alias_Is_Tracked_At_The_Use_Site()
    {
        var diagnostics = await AnalyzeAsync("""
            KevlarContext state = null!;
            await Shield.Empty.ExecuteWithContextAsync(
                ...
                {
                    var active = context;
                    var result = active.CancellationToken.GetHashCode();
                    active = other;
