...
public class IgnoredCancellationTokenTests
{
    ...
    [
        ...
        ("KevlarContext parent = null!; var result = Shield.Empty.ExecuteWithContext(parent, context => 1);", "Kevlar.Shield.ExecuteWithContext(Kevlar.KevlarContext,System.Func<Kevlar.KevlarContext,M0>)"),
        ("KevlarContext parent = null!; var result = Shield.Empty.ExecuteWithContext(parent, 1, (state, context) => state);", "Kevlar.Shield.ExecuteWithContext(Kevlar.KevlarContext,M1,System.Func<M1,Kevlar.KevlarContext,M0>)"),
        ("KevlarContext parent = null!; Shield.Empty.ExecuteWithContext(parent, context => { });", "Kevlar.Shield.ExecuteWithContext(Kevlar.KevlarContext,System.Action<Kevlar.KevlarContext>)"),
        ("KevlarContext parent = null!; Shield.Empty.ExecuteWithContext(parent, 1, (state, context) => { _ = state; });", "Kevlar.Shield.ExecuteWithContext(Kevlar.KevlarContext,M0,System.Action<M0,Kevlar.KevlarContext>)"),
        ...
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(parent, context => new ValueTask<int>(1));", "Kevlar.Shield.ExecuteWithContextAsync(Kevlar.KevlarContext,System.Func<Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<M0>>)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(parent, 1, (state, context) => new ValueTask<int>(state));", "Kevlar.Shield.ExecuteWithContextAsync(Kevlar.KevlarContext,M1,System.Func<M1,Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<M0>>)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(parent, context => ValueTask.CompletedTask);", "Kevlar.Shield.ExecuteWithContextAsync(Kevlar.KevlarContext,System.Func<Kevlar.KevlarContext,System.Threading.Tasks.ValueTask>)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(parent, 1, (state, context) => { _ = state; return ValueTask.CompletedTask; });", "Kevlar.Shield.ExecuteWithContextAsync(Kevlar.KevlarContext,M0,System.Func<M0,Kevlar.KevlarContext,System.Threading.Tasks.ValueTask>)"),
        ...
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(parent, context => Task.FromResult(1));", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield,Kevlar.KevlarContext,System.Func<Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(parent, 1, (state, context) => Task.FromResult(state));", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield,Kevlar.KevlarContext,M1,System.Func<M1,Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(parent, context => Task.CompletedTask);", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield,Kevlar.KevlarContext,System.Func<Kevlar.KevlarContext,System.Threading.Tasks.Task>)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteWithContextAsync(parent, 1, (state, context) => { _ = state; return Task.CompletedTask; });", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield,Kevlar.KevlarContext,M0,System.Func<M0,Kevlar.KevlarContext,System.Threading.Tasks.Task>)"),
        ...
        ("KevlarContext parent = null!; var result = Shield<int>.Empty.ExecuteWithContext(parent, context => 1);", "Kevlar.Shield<T0>.ExecuteWithContext(Kevlar.KevlarContext,System.Func<Kevlar.KevlarContext,T0>)"),
        ("KevlarContext parent = null!; var result = Shield<int>.Empty.ExecuteWithContext(parent, 1, (state, context) => state);", "Kevlar.Shield<T0>.ExecuteWithContext(Kevlar.KevlarContext,M0,System.Func<M0,Kevlar.KevlarContext,T0>)"),
        ...
        ("KevlarContext parent = null!; await Shield<int>.Empty.ExecuteWithContextAsync(parent, context => new ValueTask<int>(1));", "Kevlar.Shield<T0>.ExecuteWithContextAsync(Kevlar.KevlarContext,System.Func<Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<T0>>)"),
        ("KevlarContext parent = null!; await Shield<int>.Empty.ExecuteWithContextAsync(parent, 1, (state, context) => new ValueTask<int>(state));", "Kevlar.Shield<T0>.ExecuteWithContextAsync(Kevlar.KevlarContext,M0,System.Func<M0,Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<T0>>)"),
        ...
        ("KevlarContext parent = null!; await Shield<int>.Empty.ExecuteWithContextAsync(parent, context => Task.FromResult(1));", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield<M0>,Kevlar.KevlarContext,System.Func<Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>)"),
        ("KevlarContext parent = null!; await Shield<int>.Empty.ExecuteWithContextAsync(parent, 1, (state, context) => Task.FromResult(state));", "Kevlar.ShieldTaskExtensions.ExecuteWithContextAsync(Kevlar.Shield<M0>,Kevlar.KevlarContext,M1,System.Func<M1,Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>)"),
