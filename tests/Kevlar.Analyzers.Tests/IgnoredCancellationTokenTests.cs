...
public class IgnoredCancellationTokenTests
{
    ...
    [
        ...
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteAsync(context => new ValueTask<int>(1), parent);", "Kevlar.Shield.ExecuteAsync(System.Func<Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<M0>>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteAsync(1, (state, context) => new ValueTask<int>(state), parent);", "Kevlar.Shield.ExecuteAsync(M1,System.Func<M1,Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<M0>>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteAsync(context => ValueTask.CompletedTask, parent);", "Kevlar.Shield.ExecuteAsync(System.Func<Kevlar.KevlarContext,System.Threading.Tasks.ValueTask>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteAsync(1, (state, context) => { _ = state; return ValueTask.CompletedTask; }, parent);", "Kevlar.Shield.ExecuteAsync(M0,System.Func<M0,Kevlar.KevlarContext,System.Threading.Tasks.ValueTask>,Kevlar.KevlarContext)"),
        ...
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteAsync(context => Task.FromResult(1), parent);", "Kevlar.ShieldTaskExtensions.ExecuteAsync(Kevlar.Shield,System.Func<Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteAsync(1, (state, context) => Task.FromResult(state), parent);", "Kevlar.ShieldTaskExtensions.ExecuteAsync(Kevlar.Shield,M1,System.Func<M1,Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteAsync(context => Task.CompletedTask, parent);", "Kevlar.ShieldTaskExtensions.ExecuteAsync(Kevlar.Shield,System.Func<Kevlar.KevlarContext,System.Threading.Tasks.Task>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield.Empty.ExecuteAsync(1, (state, context) => { _ = state; return Task.CompletedTask; }, parent);", "Kevlar.ShieldTaskExtensions.ExecuteAsync(Kevlar.Shield,M0,System.Func<M0,Kevlar.KevlarContext,System.Threading.Tasks.Task>,Kevlar.KevlarContext)"),
        ...
        ("KevlarContext parent = null!; await Shield<int>.Empty.ExecuteAsync(context => new ValueTask<int>(1), parent);", "Kevlar.Shield<T0>.ExecuteAsync(System.Func<Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<T0>>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield<int>.Empty.ExecuteAsync(1, (state, context) => new ValueTask<int>(state), parent);", "Kevlar.Shield<T0>.ExecuteAsync(M0,System.Func<M0,Kevlar.KevlarContext,System.Threading.Tasks.ValueTask<T0>>,Kevlar.KevlarContext)"),
        ...
        ("KevlarContext parent = null!; await Shield<int>.Empty.ExecuteAsync(context => Task.FromResult(1), parent);", "Kevlar.ShieldTaskExtensions.ExecuteAsync(Kevlar.Shield<M0>,System.Func<Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>,Kevlar.KevlarContext)"),
        ("KevlarContext parent = null!; await Shield<int>.Empty.ExecuteAsync(1, (state, context) => Task.FromResult(state), parent);", "Kevlar.ShieldTaskExtensions.ExecuteAsync(Kevlar.Shield<M0>,M1,System.Func<M1,Kevlar.KevlarContext,System.Threading.Tasks.Task<M0>>,Kevlar.KevlarContext)"),
