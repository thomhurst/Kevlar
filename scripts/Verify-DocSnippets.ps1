...
[void]$builder.AppendLine('using Microsoft.Extensions.Http.Resilience;')
...
[void]$builder.AppendLine('using Polly.Hedging;')
[void]$builder.AppendLine('using Polly.Retry;')
[void]$builder.AppendLine('using Polly.Simmy;')
[void]$builder.AppendLine('using Polly.Testing;')
