...
$forbiddenDocumentationPatterns = [ordered]@{
    ...
    'analyzer behavior override' = '(?im)^\s*(?:dotnet_code_quality\.|dotnet_naming_(?:rule|style|symbols)\.|(?:csharp|dotnet)_style_)'
    ...
    'generated-code attribute' = '(?i)\b(?:CompilerGenerated|GeneratedCode)(?:Attribute)?\b'
