...
$forbiddenDocumentationPatterns = [ordered]@{
    ...
    'disabled warnings-as-errors' = '(?i)<TreatWarningsAsErrors>\s*false\s*</TreatWarningsAsErrors>'
    'excluded Kevlar analyzers' = '(?is)<PackageReference\b(?=[^>]*\bInclude\s*=\s*["'']Kevlar["''])(?=[^>]*\bExcludeAssets\s*=\s*["''][^"'']*\banalyzers\b)[^>]*>'
